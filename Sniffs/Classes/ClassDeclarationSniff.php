 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class FatchilliStandard_Sniffs_Classes_ClassDeclarationSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function _process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        */
        if ($braceLine > $classLine) {
            $error = 'Opening brace of a %s must be on the line after the %s declaration';
            $data  = array(
